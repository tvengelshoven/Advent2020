Raw_Data = """15-16 f: ffffffffffffffhf
6-8 b: bbbnvbbb
...
Letter_Count = Good_Password_Count_Part1 = Good_Password_Count_Part2 = 0

for Row in Split_Data:
    Split = Row.split(' ')
    Min_Occurance = int(Split[0].split('-')[0])
    Max_Occurance = int(Split[0].split('-')[1])
    Letter = Split[1][0]
    Password = Split[2]
    ...
    for L in Password:
        if L == Letter:
            Letter_Count += 1
    if Min_Occurance <= Letter_Count and Letter_Count <= Max_Occurance:
        Good_Password_Count_Part1 +=1
    Letter_Count = 0

    First_Letter = Password[Min_Occurance-1]
    Second_Letter = Password[Max_Occurance-1]
    Condition_1 = First_Letter == Letter
    Condition_2 = Second_Letter == Letter
    if Condition_1 + Condition_2 == 1:
        Good_Password_Count_Part2 += 1

print("Number of Good Passwords for Part 1:",Good_Password_Count_Part1)
print("Number of Good Passwords for Part 2:",Good_Password_Count_Part2)